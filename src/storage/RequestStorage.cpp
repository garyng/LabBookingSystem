...
std::vector<Request> RequestStorage::LoadDefault()
{
	return std::vector<Request>{
		...
		{3, "LAB0003", "0016", "", RequestStatus::Cancelled},
		{4, "LAB0011", "0007", "", RequestStatus::Cancelled},
		{5, "LAB0008", "0019", "", RequestStatus::Cancelled},
		{6, "LAB0004", "0019", "", RequestStatus::Cancelled},
